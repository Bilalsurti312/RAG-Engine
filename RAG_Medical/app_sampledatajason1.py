...
DATA_FILE = "sampledatajason1.json" 
DB_PATH = "chroma_db"
...
def load_medical_rag_data(filepath):
    ...
    for report in reports_list:
        ...
        patient = report.get("patientName") or "Unknown Patient"
        created_at_obj = report.get("createdAt", {})
        date_str = created_at_obj.get("$date") if isinstance(created_at_obj, dict) else "Unknown Date"
